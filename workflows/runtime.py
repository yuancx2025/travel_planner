...
from workflows.workflow import TravelPlannerWorkflow, SelectionInterrupt
...
class TravelPlannerRuntime:
    ...
    def __init__(self) -> None:
        self._workflows: Dict[str, TravelPlannerWorkflow] = {}
    ...
    def _create_workflow(self, thread_id: str) -> TravelPlannerWorkflow:
        workflow = TravelPlannerWorkflow()
        with self._lock:
            self._workflows[thread_id] = workflow
        return workflow

    def _get_or_create_workflow(self, thread_id: str) -> TravelPlannerWorkflow:
        with self._lock:
